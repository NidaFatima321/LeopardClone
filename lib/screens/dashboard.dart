...
import 'package:leopard/widgets/dashboardItem.dart';
import 'package:leopard/widgets/amountCard.dart';
      ...
      body: LayoutBuilder(builder: (context, constraints) {
        return Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Image.asset('assets/images/lep.png', width: 50.0),
                      ],
                    )
                  ],
                ),
              ...
              Container(
                color: Colors.amber[200],
                child:Text("Version 1.0.14 LIVE",
